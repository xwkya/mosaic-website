...
from mosaic_project.groupy.gconv.pytorch_gconv.splitgconv2d import P4ConvZ2, P4ConvP4, P4MConvP4M, P4MConvZ2
from mosaic_project.groupy.gconv.pytorch_gconv.pooling import plane_group_spatial_max_pooling
import kornia
...
class NNGCNN2(NNModel):
    def __init__(self, out_features, out_groups, name_to_index, name, predict_loss=True):
    ...
    def forward(self, x):
        ...
        x = x.view(bsz, 8 , -1) # x: (bsz, 8, feat_size)
        x = F.relu(self.fc1(x))
        x = F.relu(self.fc2(x))
